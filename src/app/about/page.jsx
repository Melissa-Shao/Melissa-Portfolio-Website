          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            <div className="text-lg">
              ...
              <p className="pb-2">
                ...
                satisfying to me. I also enjoy testing and debugging, as my
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3">
                  ...
                  <div className="p-3 text-sm italic">
                    Analyzed financial products, delivered financial advice,
              ...
              <div className="flex justify-between h-48">
                {/* left */}
                <div className="w-1/3">
                  <div className="bg-white p-3 mt-40 md:mt-0 lg:mt-0 font-semibold rounded-b-lg rounded-s-lg">
                    Lobby Manager
                  </div>
                  <div className="p-3 text-sm italic">
                    Implemented data-driven strategies, implemented data-driven
                    strategies and spearheaded a data system.
                  </div>
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    {" "}
                    Jan 2014 - Jun 2016
              ...
              <div className="flex justify-between h-48">
                ...
                {/* right */}
                <div className="w-1/3">
                  <div className="bg-white p-3 mt-36 md:mt-0 lg:mt-0 font-semibold rounded-b-lg rounded-s-lg">
                    Bank Clerk/Teller
                  </div>
                  <div className="p-3 text-sm italic">
                    Utilized data analysis techniques, leveraged data insights
                    and implemented data-driven solutions.
                  </div>
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    Jul 2013 - Jan 2014
                  </div>
            ...
            >
              ...
              <div className="flex justify-between h-56">
                ...
                {/* right */}
                <div className="w-5/6">
                  <div className="bg-white p-3 font-semibold rounded-b-lg rounded-s-lg w-3/4">
