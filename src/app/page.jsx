    ...
    <motion.div className="h-full"
      ...
      <div className="h-full flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48">
        ...
        <div className="h-1/2 flex flex-col lg:h-full lg:w-1/2 gap-8 items-center justify-center">
          ...
          {/* desc */}
          <p className="md:text-xl">Welcome to my digital canvas, where innovation, creativity, and technical expertise converge. With a keen eye for aesthetics, a mastery of code, and a deep understanding of data, my portfolio showcases a diverse collection of projects that reflect my commitment to excellence.</p>
          {/* buttons */}
